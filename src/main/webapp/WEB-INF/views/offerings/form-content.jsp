        ...
        <c:choose>
          ...
          <c:otherwise>
            <div class="alert alert-info">
              <span class="fa fa-info-circle"></span> To upload offerings, you need to exist at least one store. Go to <a class="alert-link" href="${ pageContext.request.contextPath }/stores/register">register store</a>.
            </div>
          </c:otherwise>
        </c:choose>
      </div>
