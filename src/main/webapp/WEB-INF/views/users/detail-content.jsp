        ...
        <c:choose>
          <c:when test="${ user.oauth2 eq true }">
            ...
            <form class="col-sm-8 col-sm-offset-1" method="post" action="${ pageContext.request.contextPath }/account">
              ...
              <div class="form-field readonly">
                <label class="text-plain">OAuth2</label>
                <input class="form-control" type="text" name="oauth2" value="Logged in through 'Identity Manager'" />
              </div>

              <div class="form-options">
                <button type="submit" class="btn btn-success btn-sm-10 btn-md-5" disabled>Update Profile</button>
              </div>
            </form>
